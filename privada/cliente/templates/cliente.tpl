			...
			<tr>
			  ...
			  <td align="center">
			  	<form name="formElimi{$r.id_cliente}" method="post" action="cliente_eliminar.php">
			  		<input type="hidden" name="id_cliente" value="{$r.id_cliente}">
			  		<a href="javascript:document.formElimi{$r.id_cliente}.submit();" title="Eliminar cliente Sistema" onclick="javascript:return(confirm('Desea realmente Eliminar el cliente..?')); location.href='cliente_eliminar.php'">
			  			Eliminar>>
			  		</a>
			  	</form>	
			  </td>
