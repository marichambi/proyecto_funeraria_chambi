			...
			<tr>
			  ...
			  <td align="center">
			  	<form name="formElimi{$r.id_producto}" method="post" action="producto_eliminar.php">
			  		<input type="hidden" name="id_producto" value="{$r.id_producto}">
			  		<a href="javascript:document.formElimi{$r.id_producto}.submit();" title="Eliminar producto Sistema" onclick="javascript:return(confirm('Desea realmente Eliminar el producto..?')); location.href='producto_eliminar.php'">
			  			Eliminar>>
			  		</a>
			  	</form>	
			  </td>
